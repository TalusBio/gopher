# Contributing to gopher-enrich

First off, thank you for taking the time to contribute.

The following document provides guidelines for contributing to the
documentation and the code of gopher-enrich. **No contribution is too small!** Even
...
1. Create your own fork of the gopher-enrich repository on GitHub.

2. Clone your forked gopher-enrich repository to work on locally.
...
6. On the GitHub page for you forked repository, click "Pull request" to propose
   adding your changes to gopher-enrich.

7. We'll review, discuss, and help you make any revisions that are required. If
   all goes well, your changes will be added to gopher-enrich
   in the next release!


### Python code style

The gopher-enrich project follows the [PEP 8
...
format code and lint Python code in gopher-enrich.
...
2. Navigate to your local copy of the gopher-enrich repository and activate the hook:
```bash
pre-commit install
```
